...
void sul_monitor::create_dispaly()
{
        ...
        fmodel = new QStandardItemModel(8, 16);
        rmodel = new QStandardItemModel(8, 16);
...
void sul_monitor::config_system()
{
        ...
        */
        ...
        QVariant ifc = settings->value("INTERFACE", "COM3");
...
void sul_monitor::create_system()
{
        ...
        grid = new grid_array(sul,NULL,Qt::WindowStaysOnTopHint);
        ...
        ang = new angle_correct(5.08,4.4,1.0,1.0);
