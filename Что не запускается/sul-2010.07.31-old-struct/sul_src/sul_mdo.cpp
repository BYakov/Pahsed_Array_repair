...
sul_mdo::sul_mdo( device *hw, const char *sul_mdo_config, const char *ram_mdo_config, int modules, int channels ):
sul_base( sul_mdo_config, ram_mdo_config, modules, channels)
{
