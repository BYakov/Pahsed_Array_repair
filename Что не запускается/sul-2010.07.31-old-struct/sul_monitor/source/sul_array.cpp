...
sul_array::sul_array(sul_base *Sul, QWidget *parent, Qt::WFlags flags)
: QWidget(parent, flags)
{
    setWindowTitle(tr("Антенная решетка"));
    setWindowIcon(QIcon("icon\\array_icon.png"));
...
void sul_array::paint_grid_channels(QPaintEvent *event)
{
    float ScaleX = 0;
    float ScaleY = 0;
...
void sul_array::paint_grid_calculators(QPaintEvent *event)
{
    float ScaleX = 0;
    float ScaleY = 0;
...
void sul_array::paint_grid_phases(QPaintEvent *event)
{
    float ScaleX = 0;
    float ScaleY = 0;
...
void sul_array::paint_grid_pulses(QPaintEvent *event)
{
    float ScaleX = 0;
    float ScaleY = 0;
...
void sul_array::show_calculators(bool Fi0)
{
   fi0 = Fi0;
