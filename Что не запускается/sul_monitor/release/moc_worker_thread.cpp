...
**
** Created: Sat 24. Jan 14:19:46 2015
**      by: The Qt Meta Object Compiler version 62 (Qt 4.7.4)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../source/worker_thread.h"
...
static const char qt_meta_stringdata_worker_thread[] = {
    "worker_thread\0\0status,task_code\0"
    "task_status(int,int)\0"
};
...
int worker_thread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: task_status((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void worker_thread::task_status(int _t1, int _t2)
{
