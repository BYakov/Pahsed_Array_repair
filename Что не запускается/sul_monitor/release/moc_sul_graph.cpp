...
static const char qt_meta_stringdata_sul_graph[] = {
    "sul_graph\0\0X,Y\0set_beam_position(double,double)\0"
};
...
int sul_graph::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: set_beam_position((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void sul_graph::set_beam_position(double _t1, double _t2)
{
