...
sul_graph::sul_graph(scanner *Scan, QWidget *parent, Qt::WindowFlags flags)
: QWidget(parent, flags)
{
        QTextCodec::setCodecForLocale(QTextCodec::codecForName("UTF-8"));
        setWindowTitle(QString::fromUtf8("Сканирование лучом"));
        setWindowIcon(QIcon("config\\icon\\beam_icon.png"));
        scan = Scan;
...
void sul_graph::paintEvent(QPaintEvent *event)
{
        ...
        p.setPen(Qt::black);//p.setPen(Qt::darkBlue);
